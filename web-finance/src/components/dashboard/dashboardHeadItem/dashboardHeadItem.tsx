...
export const DashboardHeadItem = ({ title, amount, variation }: DashboardHeadItemProps) => {
  ...
  return (
    <article className="flex flex-col justify-around items-center rounded-md shadow-2xs bg-gray-900 transform transition-transform duration-300 hover:scale-102">
